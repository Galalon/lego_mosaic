...
from dithering.pipeline import DITHERING_METHODS
from tiling.pipeline import TILING_METHODS
...
if __name__ == "__main__":
    ...
    parser.add_argument("--palette", type=str, default="pearler_beads", choices=COLOR_PALETTES.keys(), help="Color palette name")
    parser.add_argument("--dither_method", type=str, default='error_diffusion_raster',choices=DITHERING_METHODS.keys() ,help="Name of the dithering method")
    parser.add_argument("--color_space", type=str, default="LAB", choices=["RGB", "LAB", "HSV"], help="Color space to use")
    parser.add_argument("--tile_method", type=str, default="greedy_fill",choices=TILING_METHODS.keys(), help="Tiling method name")
